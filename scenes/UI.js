class UI extends Phaser.Scene {
  ...
  create() {
	...
	//this.dataText = this.add.bitmapText(450, 75, 'atari', 'data', 40).setOrigin(.5).setTint(0xffffff).setAlpha(1);
//	this.countIcon = this.add.image(85, 75, 'hex').setScale(1.5);
    //this.totalclearedText = this.add.bitmapText(50, 175, 'atari', '0', 60).setOrigin(.5).setTint(0xffffff).setAlpha(1);
    ...
    if(gameOptions.gameMode == 'time' || gameOptions.gameMode == 'moves'){
	  //this.totalClearedIcon = this.add.image(400, 75, 'atari').setScale(.7).setAlpha(1);
	...
	//this.totalTalleyText = this.add.bitmapText(50, 125, 'atari', JSON.stringify(this.tally), 30).setOrigin(0, .5).setTint(0xffffff).setAlpha(1).setMaxWidth(600);
    //this.button1 = this.add.image(50, 1200, 'hex');
